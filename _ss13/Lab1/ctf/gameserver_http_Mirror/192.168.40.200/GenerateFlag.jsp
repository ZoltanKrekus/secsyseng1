...
<p><a href="regeln.jsp">CTF-Regeln</a> <a href="submitflag.jsp">Submit Flag</a> <a href="protokoll_vorlage.txt">Vorlage Protokoll</a></p>
        ...
        <div id="content">
            ...
            <div>
                <p>
                    Mittels der Funktion Generate a Flag k&ouml;nnen Sie ein Test-Flag f&uuml;r das ausgew&auml;hlte Service an ein ausgew&auml;hltes Team schicken. Sie erhalten anschlie&szlig;end den Status des Speicherns des Flags zur&uuml;ck. Hinweis: Diese generierten Test-Flags <a href="punkte.jsp">beinhalten den String TEST</a> und gelten damit _nicht_ f&uuml;r die Punktewertung -- Test-Flags k&ouml;nnen Sie nicht am Gameserver abgeben, um daf&uuml;r Punkte zu erhalten!
                </p>
            </div>
